<div class="element cursor-set swiper-slide element1">
    <div class="icon mobile"></div>
    <div class=text>Mobile-friendy Design</div>
</div>
<div class="element cursor-set swiper-slide element2">
    <div class="icon rocket"></div>
    <div class=text>Performance Optimization</div>
</div>
<div class="element cursor-set swiper-slide element3">
    <div class="icon phone-pc-link"></div>
    <div class=text>Responsive Design</div>
</div>
<div class="element cursor-set swiper-slide element4">
...
<div class="element cursor-set swiper-slide element5">
    <div class="icon bug"></div>
    <div class=text>Test and debugging</div>
</div>
<div class="element cursor-set swiper-slide element6">
