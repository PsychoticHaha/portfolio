...
<div class="element swiper-slide element5">
    <div class="icon bug"></div>
    <div class=text>Test and debugging</div>
</div>
<div class="element swiper-slide element6">
