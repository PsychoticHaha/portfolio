...
class Comments extends Composer
{
    ...
    public function title(): string
    {
        return sprintf(
            ...
            _nx('%1$s response to &ldquo;%2$s&rdquo;', '%1$s responses to &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'psychotix'),
            get_comments_number() === 1 ? _x('One', 'comments title', 'psychotix') : number_format_i18n(get_comments_number()),
            get_the_title()
        );
    }
    ...
    public function previous(): ?string
    {
        ...
        return get_previous_comments_link(
            __('&larr; Older comments', 'psychotix')
        );
    }
    ...
    public function next(): ?string
    {
        ...
        return get_next_comments_link(
            __('Newer comments &rarr;', 'psychotix')
        );
    }
